...
type NetworkInterface interface {
	...
	Patch(name string, pt types.PatchType, data []byte) (*cluster.Network, error)
}
...
func (c *networks) Patch(name string, pt types.PatchType, data []byte) (result *cluster.Network, err error) {
	result = &cluster.Network{}
